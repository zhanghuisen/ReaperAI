...
function CapabilityRegistry.create(deps)
  ...
  local CAPABILITY_CARDS = {
    ...
    ["track/delete"] = { intent = "delete tracks", target_binding = "index/name/match/selected", params = { "index", "name", "match", "selected" }, prefer_mcp_when = "deleting tracks by stable target", allow_script = false, risk = "destructive", verifier = "track/delete", repair = "require explicit target" },
    ...
    ["track/set_volume"] = { intent = "set track volume", target_binding = "index/name/track/selected/created.tracks", params = { "index", "name", "track", "target", "selected", "volume" }, prefer_mcp_when = "track gain changes", allow_script = false, risk = "modify", verifier = "track/property", repair = "require volume and stable track target" },
    ...
    ["track/set_pan"] = { intent = "set track pan", target_binding = "index/name/track/selected/created.tracks", params = { "index", "name", "track", "target", "selected", "pan" }, prefer_mcp_when = "track pan changes", allow_script = false, risk = "modify", verifier = "track/property", repair = "require pan and stable track target" },
    ["track/set_color"] = { intent = "set track color", target_binding = "index/name/track/selected/created.tracks", params = { "index", "name", "track", "target", "selected", "color" }, prefer_mcp_when = "static track colors", allow_script = false, risk = "modify", verifier = "track/property", repair = "use color name, #RRGGBB, or r,g,b with stable target" },
    ["track/mute"] = { intent = "mute or unmute tracks", target_binding = "index/name/track/selected/created.tracks", params = { "index", "name", "track", "target", "selected", "mute" }, prefer_mcp_when = "mute toggles", allow_script = false, risk = "modify", verifier = "track/property", repair = "require mute=true/false and stable target" },
    ["track/solo"] = { intent = "solo or unsolo tracks", target_binding = "index/name/track/selected/created.tracks", params = { "index", "name", "track", "target", "selected", "solo" }, prefer_mcp_when = "solo toggles", allow_script = false, risk = "modify", verifier = "track/property", repair = "require solo=true/false and stable target" },
    ...
    ["marker/delete"] = { intent = "delete marker", target_binding = "index/created.markers", params = { "index", "target", "marker" }, prefer_mcp_when = "marker deletion", allow_script = false, risk = "destructive", verifier = "marker/delete", repair = "require marker index; never default to #0" },
  ...
  CAPABILITY_CARDS["region/delete"] = {
    ...
    target_binding = "region id/range/name",
    params = { "index", "id", "region", "target", "range", "ids", "start", "end", "order_start", "order_end", "order_range", "name", "match" },
