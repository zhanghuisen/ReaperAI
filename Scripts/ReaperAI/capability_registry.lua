...
function CapabilityRegistry.create(deps)
  ...
  local CAPABILITY_CARDS = {
    ...
    ["track/set_color"] = { intent = "set or clear track color", target_binding = "index/range/ids/name/track/selected/all/created.tracks", params = { "index", "range", "ids", "start", "end", "order_start", "order_end", "name", "match", "track", "target", "selected", "all", "color" }, prefer_mcp_when = "single or batch static track colors or clearing custom/default color", allow_script = false, risk = "modify", verifier = "track/property", repair = "use color name, #RRGGBB, r,g,b, or color=default/clear with stable target" },
    ...
    ["region/set_color"] = { intent = "set Region color only", target_binding = "region id/range/ids/name/all/selected/current/time_selection", params = { "index", "id", "region", "target", "range", "ids", "start", "end", "order_start", "order_end", "order_range", "name", "match", "selected", "scope", "all", "color" }, prefer_mcp_when = "single or batch Region color changes, including inferred selected Region", allow_script = false, risk = "modify", verifier = "region/property", repair = "use Region-specific target and color; never route through Marker operations" },
    ["item/set_color"] = { intent = "set MediaItem color only", target_binding = "index/range/ids/name/selected/all/time_selection/created.items", params = { "index", "range", "ids", "start", "end", "order_start", "order_end", "name", "match", "target", "item", "selected", "all", "time_selection", "scope", "color" }, prefer_mcp_when = "single or batch Item color changes", allow_script = false, risk = "modify", verifier = "item/property", repair = "use color name, #RRGGBB, r,g,b, or color=default/clear with explicit item target" },
