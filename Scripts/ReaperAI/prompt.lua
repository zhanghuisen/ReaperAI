...
- item/set_color - 设置 MediaItem 颜色，支持 index/name/selected/all/time_selection 和 color=黄色/#FFFF00/r,g,b；只作用于 Item
- region/set_color - 设置 Region 颜色，支持 index/range/ids/name/all/selected/current/time_selection 和 color=黄色/#FFFF00/r,g,b；只作用于 Region，永远不要用于 Marker
